    ...
    return (
        <nav className="bg-background select-none">
            <div className="justify-between px-4 mx-auto lg:max-w-7xl md:items-center md:flex md:px-8">
                ...
                <div>
                    <div
                        className={`z-10 absolute m-auto left-0 right-0 md:static bg-white dark:bg-slate-900 dark:md:bg-transparent justify-self-center border p-4 rounded-md md:block md:p-0 md:mt-0 md:border-none ${navbar ? "block" : "hidden"
                            }`}
